...
DomainErrorTranslator._directories = {
  ...
  'ADD_COMMENT_USE_CASE.NOT_CONTAIN_CONTENT': new InvariantError('properti content tidak ada'),
  'ADD_COMMENT_USE_CASE.PAYLOAD_NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('content harus string'),
};
